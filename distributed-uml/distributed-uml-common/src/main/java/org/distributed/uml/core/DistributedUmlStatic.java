...
public class DistributedUmlStatic {
	...
	private static String getNormalizedPath() {
		 ...
		 * fix properties
		 */
		if(System.getProperty("distributed-uml.user.dir") == null) {
			System.setProperty("distributed-uml.user.dir", normalizedPath);
		}
		if(System.getProperty("distributed-uml.log.dir") == null) {
			System.setProperty("distributed-uml.log.dir", normalizedPath);
		}
